...
export async function generateMetadata({ params }: { params: any }) {
  return {
    title:
      params.locale === "en"
        ? "For social transport"
        : "Для соціального транспорту",
  };
}
...
const data: PreviewData[] = [
  { title: "1.title", src: "/product/social/preview/social-1.webp" },
  { title: "2.title", src: "/product/social/preview/social-2.webp" },
  { title: "3.title", src: "/product/social/preview/social-3.webp" },
