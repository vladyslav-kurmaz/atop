...
const data: PreviewData[] = [
  { title: "1.title", src: "/product/system/preview/1-1.webp" },
  { title: "2.title", src: "/product/system/preview/2-1.webp" },
  { title: "3.title", src: "/product/system/preview/3-1.webp" },
  { title: "4.title", src: "/product/system/preview/4-1.webp" },
];

export default async function Products({ params }: { params: Params }) {
  const { t } = await initTranslations(params.locale, ["system"]);
