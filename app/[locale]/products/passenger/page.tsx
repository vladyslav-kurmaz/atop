...
const data: PreviewData[] = [
  { title: "1.title", src: "/product/passenger/preview/pass-1.webp" },
  { title: "2.title", src: "/product/passenger/preview/pass-2.webp" },
  { title: "3.title", src: "/product/passenger/preview/pass-3.webp" },
  { title: "4.title", src: "/product/passenger/preview/pass-4.webp" },
  { title: "5.title", src: "/product/passenger/preview/pass-5.webp" },
  { title: "6.title", src: "/product/passenger/preview/pass-6.webp" },
  { title: "7.title", src: "/product/passenger/preview/pass-7.webp" },
];

export default async function Products({ params }: { params: Params }) {
  const { t } = await initTranslations(params.locale, ["passengers"]);
