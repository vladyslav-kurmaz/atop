...
const data: PreviewData[] = [
  { title: "1.title", src: "/product/special/preview/special-1.webp" },
  { title: "2.title", src: "/product/special/preview/special-2.webp" },
  { title: "3.title", src: "/product/special/preview/special-3.webp" },
  // { title: "4.title", src: "/product/social/preview/social-4.webp" },
  // { title: "5.title", src: "/product/social/preview/social-5.webp" },
  // { title: "6.title", src: "/product/social/preview/social-6.webp" },
  // { title: "7.title", src: "/product/social/preview/social-7.webp" },
];

export default async function Products({ params }: { params: Params }) {
  const { t } = await initTranslations(params.locale, ["special-wagon"]);
    ...
    return data.map((item, i) => {
      ...
      return (
        <li className="products__list-item h-[459px] lg:h-[427px]" key={i}>
          <Link
            href={`/products/special-wagons/${i}`}
