...
const Enterprice = async ({ params }: { params: Params }) => {
  ...
  return (
    <div className="mainPage__enterprise">
      <h2 className="mainPage__enterprise-title">{t("enterprice.title")}</h2>
      ...
      <ul className="mainPage__enterprise-list">
        {data.map((item) => (
          <li key={item.title} className="mainPage__enterprise-list-item">
            <Link
              href={item.link}
              className="mainPage__enterprise-list-item-overLink"
            ></Link>

            <div className="mainPage__enterprise-list-item-content">
              <div className="mainPage__enterprise-list-item-content-container">
                <h4 className="mainPage__enterprise-list-item-content-container-title">
                  {t(item.title)}
                  <Link
                    href={item.link}
                    className="mainPage__enterprise-list-item-content-button"
                  >
                    <svg
                ...
                <Link
                  href={item.link}
                  className="mainPage__enterprise-list-item-content-container-button"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
