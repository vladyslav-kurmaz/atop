  ...
  return (
    <div className="mainPage__contacts" id='contacts'>
      <div className="mainPage__contacts-container">
        <h3 className="mainPage__contacts-container-title">{t("contacts.title")}</h3>
        <ul className="mainPage__contacts-container-list">
          <li className="mainPage__contacts-container-list-item">
            <span className="mainPage__contacts-container-list-item-title">{t("contacts.adress")}</span>
            <p className="mainPage__contacts-container-list-item-text">
            {t("contacts.adress-info")}
            </p>
          </li>
          <li className="mainPage__contacts-container-list-item">
            <span className="mainPage__contacts-container-list-item-title">{t("contacts.post")}</span>
            <p className="mainPage__contacts-container-list-item-text">info@ator.com.ua</p>
          </li>
          <li className="mainPage__contacts-container-list-item">
            <span className="mainPage__contacts-container-list-item-title">{t("contacts.phone")}</span>
